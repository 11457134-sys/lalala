...
<main>
    ...
    <div class="info-card" id="map">
        ...
        <div class="map-wrapper">
            <iframe src="https://maps.google.com/maps?q=八德生態埤塘自然公園&t=&z=15&ie=UTF8&iwloc=&output=embed" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <div class="info-box">
    ...
    <div id="bird-section">
        ...
        <div class="card-grid">
            ...
            <div class="bird-card">
                <div class="thumbnail-wrapper">
                    <img src="moorhen.jpg" alt="紅冠水雞">
                </div>
                <div class="card-content">
                    <h4>紅冠水雞</h4>
                    <button class="cta-btn" onclick="alert('開啟常見留鳥紅冠水雞的築巢與育雛行為觀察紀錄！')">瀏覽繁殖紀錄</button>
                </div>
            </div>

            <div class="bird-card">
                <div class="thumbnail-wrapper">
                    <img src="night_heron.jpg" alt="夜鷺">
                </div>
                <div class="card-content">
                    <h4>夜鷺</h4>
                    <button class="cta-btn" onclick="alert('開啟夜行性鷺科夜鷺的夜間覓食活動範圍動態圖表！')">查看夜間生態</button>
                </div>
            </div>
        </div>
    </div>
